...
def preprocess_help(s: str):
    ...
    s = re.sub(r"default: /.*/reaper", "default: <CACHE_DIR>", s)
    # Remove the commit SHA and target architecture triple
    s = re.sub(r"default: reaper/.*-[0-9A-Fa-f]{6,10}/\w+-\w*-\w+", "default: reaper/<VERSION>-<SHA>/<ARCH>", s)
    # Remove the OS
    s = re.sub(r"default: reaper/.*/\w+", "default: reaper/<VERSION>/<OS>", s)
