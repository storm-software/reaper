...
use reaper_eth_engine_core::TraceLoaderError;
pub use reaper_eth_engine_types::constants::*;
...
impl InspectorTestUtils {
  ...
  async fn get_block_tree(&self, block: u64) -> Result<BlockTree<Action>, InspectorTestUtilsError> {
    self
      .classifier_inspector
