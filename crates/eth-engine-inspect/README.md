...
- [Reaper - Ethereum Engine Inspect Crate](#reaper---ethereum-engine-inspect-crate)
  - [Installing](#installing)
  - [Development](#development)
    - [Building](#building)
    - [Running unit tests](#running-unit-tests)
    - [Linting](#linting)
  - [Updating the libmdbx Version](#updating-the-libmdbx-version)
...
# Reaper - Ethereum Engine Inspect Crate
...
```toml
[dependencies]
reaper-eth-engine-inspect = "0.0.1"
```

Or, via the command line:

```bash
cargo add reaper-eth-engine-inspect
```
...
Run `nx build reaper-eth-engine-inspect` to build the library.

### Running unit tests

Run `nx test reaper-eth-engine-inspect` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint reaper-eth-engine-inspect` to run [ESLint](https://eslint.org/) on the
package.
