...
- [Reaper - Ethereum Engine Type Definition Crate](#reaper---ethereum-engine-type-definition-crate)
...
# Reaper - Ethereum Engine Type Definition Crate
...
```toml
[dependencies]
reaper-eth-engine-types = "0.0.1"
```

Or, via the command line:

```bash
cargo add reaper-eth-engine-types
```
...
Run `nx build reaper-eth-engine-types` to build the library.

### Running unit tests

Run `nx test reaper-eth-engine-types` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint reaper-eth-engine-types` to run [ESLint](https://eslint.org/) on
the package.
