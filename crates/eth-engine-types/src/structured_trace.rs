    ...
    match &self.trace.action {
      Action::Call(call) => {
        ...
        call.to == SCP_MAIN_CEX_DEX_BOT
          || call.to == Address::from_str("0xfbEedCFe378866DaB6abbaFd8B2986F5C1768737").unwrap()
...
impl Serialize for TxTrace {
    ...
    S: serde::Serializer,
  {
    ...
    ser_struct.serialize_field("trace_decoded_data.function_name", &decoded_data.function_name)?;
    ...
    ser_struct
      .serialize_field("trace_self_destruct_actions.trace_idx", &self_destruct_action.trace_idx)?;
    ser_struct
      .serialize_field("trace_self_destruct_actions.address", &self_destruct_action.address)?;
    ser_struct
      .serialize_field("trace_self_destruct_actions.balance", &self_destruct_action.balance)?;
    ...
    ser_struct.serialize_field("trace_reward_actions.reward_type", &reward_action.reward_type)?;
