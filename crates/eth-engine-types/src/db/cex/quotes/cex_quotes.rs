...
impl CexPriceMap {
  ...
  pub fn get_quote_at(
    ...
    self
      .get_exchange_quote_at_direct(pair, exchange, timestamp, max_time_diff)
      .or_else(|| {
        self.get_exchange_quote_at_via_intermediary(pair, exchange, timestamp, max_time_diff)
      })
  }
