...
impl DexQuotes {
    ...
    pub fn price_at(&self, mut pair: Pair, mut tx: usize) -> Option<DexPrices> {
        ...
        debug!(target: "reaper-eth-engine::missing_pricing",?pair, at_or_before=?s_idx, "no price for pair");
    ...
    pub fn price_at(&self, mut pair: Pair, tx: usize) -> Option<DexPrices> {
        ...
        debug!(target: "reaper-eth-engine::missing_pricing",?pair, at=?s_idx, "no price for pair");
