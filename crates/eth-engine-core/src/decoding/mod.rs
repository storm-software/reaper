...
use reaper_eth_engine_types::structured_trace::TxTrace;
pub use reaper_eth_engine_types::traits::TracingProvider;
...
impl<T: TracingProvider, DB: LibmdbxReader + DBWriter> Parser<T, DB> {
  ...
  pub fn execute(
    ...
    // than the process that runs reaper_eth_engine.
