...
# Storm Software - Trading Core Crate
...
```toml
[dependencies]
storm-trading-core = "0.0.1"
```

Or, via the command line:

```bash
cargo add storm-trading-core
```
...
Run `nx build storm-trading-core` to build the library.

### Running unit tests

Run `nx test storm-trading-core` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint storm-trading-core` to run [ESLint](https://eslint.org/) on the
package.
