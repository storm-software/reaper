    ...
    C: Calendar,
{
    ...
    /// use reaper_core::time::day_counting::DayCounter;
    /// use reaper_core::time::countries::oceania::australia::AustraliaCalendar;
    ///
    ...
    /// use reaper_core::time::day_counting::DayCounter;
    /// use reaper_core::time::countries::oceania::australia::AustraliaCalendar;
    /// use reaper_core::time::day_counting::DayCountConvention;
    ///
    /// let date1 = date!(2023-01-01);
...
mod TESTS_thirty_360 {
    ...
    fn thirty_e_365() {
        ...
        assert_approx_equal!(dcf, 1.515_068_493, reaper_core_EPSILON);
    }
}
...
mod TESTS_actual_constant {
    ...
    fn actual_365_25() {
        ...
        for i in 1..test_dates.len() {
            ...
            assert_approx_equal!(dcf, expected[i - 1], reaper_core_EPSILON);
        }
    }
