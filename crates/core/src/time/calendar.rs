...
use crate::time::utilities::is_weekend;
use time::Date;
...
pub struct CalendarMetadata {
  ...
  pub country_code: crate::iso::ISO_3166,

  /// ISO 10383 market identifier code.
  pub market_identifier_code: crate::iso::ISO_10383,
}
...
impl CalendarMetadata {
  ...
  pub fn new(
    name: &'static str,
    country_code: crate::iso::ISO_3166,
    market_identifier_code: crate::iso::ISO_10383,
  ) -> Self {
    Self { name, country_code, market_identifier_code }
  }
  ...
  /// Returns the ISO 3166-1 country code.
  pub fn country_code(&self) -> crate::iso::ISO_3166 {
    self.country_code
  }

  /// Returns the ISO 10383 market identifier code.
  pub fn market_identifier_code(&self) -> crate::iso::ISO_10383 {
