...
use eyre::eyre;
use reaper_eth_engine_types::{structured_trace::TxTrace, traits::TracingProvider};
use reth_primitives::{
...
impl TracingProvider for TracingClient {
  ...
  async fn replay_block_transactions(
    ...
    self
      .replay_block_transactions_with_inspector(block_id)
      .await
      .map_err(Into::into)
  }
    ...
    match (call_gas_price, call_max_fee, call_priority_fee, max_fee_per_blob_gas) {
      ...
      (None, max_fee_per_gas, max_priority_fee_per_gas, None) => {
        ...
        let effective_gas_price =
          get_effective_gas_price(max_fee_per_gas, max_priority_fee_per_gas, block_base_fee)?;
