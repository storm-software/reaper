...
- [Reaper - Ethereum Engine RETH Tracing Crate](#reaper---ethereum-engine-reth-tracing-crate)
...
# Reaper - Ethereum Engine RETH Tracing Crate
...
```toml
[dependencies]
reaper-eth-engine-reth-tracing = "0.0.1"
```

Or, via the command line:

```bash
cargo add reaper-eth-engine-reth-tracing
```
...
Run `nx build reaper-eth-engine-reth-tracing` to build the library.

### Running unit tests

Run `nx test reaper-eth-engine-reth-tracing` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint reaper-eth-engine-reth-tracing` to run
