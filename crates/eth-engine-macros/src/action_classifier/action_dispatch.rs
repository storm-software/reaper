  ...
  pub fn expand(self) -> syn::Result<TokenStream> {
    ...
    Ok(quote!(
                ...
                impl crate::ActionCollection for #struct_name {
                    fn dispatch<DB: ::reaper_eth_engine_database::libmdbx::LibmdbxReader
    + ::reaper_eth_engine_database::libmdbx::DBWriter
                        ...
                        tx_idx: u64,
                            ...
                            ::reaper_eth_engine_pricing::types::DexPriceMsg,
                            ::reaper_eth_engine_types::normalized_actions::Action
                        )> {
