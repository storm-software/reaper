...
# Reaper - Ethereum Engine Macros Crate
...
```toml
[dependencies]
reaper-eth-engine-macros = "0.0.1"
```

Or, via the command line:

```bash
cargo add reaper-eth-engine-macros
```
...
Run `nx build reaper-eth-engine-macros` to build the library.

### Running unit tests

Run `nx test reaper-eth-engine-macros` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint reaper-eth-engine-macros` to run [ESLint](https://eslint.org/) on
the package.
