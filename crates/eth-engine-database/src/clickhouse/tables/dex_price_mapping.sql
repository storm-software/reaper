CREATE TABLE engine.dex_price_mapping ON CLUSTER eth_cluster0
(
    `block_number` UInt64,
    `tx_idx` UInt64,
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/eth_cluster0/tables/all/engine/dex_price_mapping', '{replica}', `last_updated`)
