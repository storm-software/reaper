...
impl<I: LibmdbxInit> LibmdbxInit for ClickhouseMiddleware<I> {
    async fn initialize_table<T: reaper_eth_engine_types::traits::TracingProvider, CH: ClickhouseHandle>(
        &'static self,
    ...
    async fn initialize_table_arbitrary<
        T: reaper_eth_engine_types::traits::TracingProvider,
        CH: ClickhouseHandle,
    >(
        &'static self,
        clickhouse: &'static CH,
...
impl<I: LibmdbxInit> LibmdbxReader for ClickhouseMiddleware<I> {
    ...
    fn get_cex_trades(
        &self,
        block: u64,
    ) -> eyre::Result<reaper_eth_engine_types::db::cex::trades::CexTradeMap> {
