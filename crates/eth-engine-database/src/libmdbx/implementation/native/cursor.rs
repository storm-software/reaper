...
use reaper_eth_engine_libmdbx::{Error, TransactionKind, WriteFlags, RW};
use reth_db::{
...
pub struct LibmdbxCursor<T: Table, K: TransactionKind> {
    ...
    pub(crate) inner: reaper_eth_engine_libmdbx::Cursor<K>,
    /// Phantom data to enforce encoding/decoding.
    _dbi:             PhantomData<T>,
}

impl<T: Table, K: TransactionKind> LibmdbxCursor<T, K> {
    pub(crate) fn new(inner: reaper_eth_engine_libmdbx::Cursor<K>) -> Self {
