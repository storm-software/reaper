...
/// in the ReaperEthEngineBatchPricer system. It ensures the accuracy and
/// relevance of subgraphs, which are essential for pricing tokens on DEXs.
///
...
impl SubgraphVerifier {
  ...
  fn passed_verification(
    ...
    VerificationResults::Passed(VerificationPass { pair, block, subgraph, prune_state: removals })
  }
}
