...
- [Reaper - Ethereum Engine Pricing Crate](#reaper---ethereum-engine-pricing-crate)
...
# Reaper - Ethereum Engine Pricing Crate
...
```toml
[dependencies]
reaper-eth-engine-pricing = "0.0.1"
```

Or, via the command line:

```bash
cargo add reaper-eth-engine-pricing
```
...
Run `nx build reaper-eth-engine-pricing` to build the library.

### Running unit tests

Run `nx test reaper-eth-engine-pricing` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint reaper-eth-engine-pricing` to run [ESLint](https://eslint.org/) on
the package.
