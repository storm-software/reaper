...
impl GlobalRangeMetrics {
    pub fn new(per_range_blocks: Vec<u64>) -> Self {
        let completed_blocks_range = register_int_counter_vec!(
            "reaper_eth_engine_range_specific_completed_blocks",
        ...
        let total_blocks_range = register_int_counter_vec!(
            "reaper_eth_engine_range_specific_total_blocks",
        ...
        Self {
            ...
            completed_blocks: metrics::register_counter!("reaper_eth_engine_total_completed_blocks"),
            processing_run_time_ms: metrics::register_histogram!("reaper_eth_engine_processing_runtime_ms"),
        }
    }
...
#[metrics(scope = "reaper_eth_engine_running_ranges")]
