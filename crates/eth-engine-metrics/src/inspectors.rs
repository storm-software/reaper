...
use reaper_eth_engine_types::{mev::MevType, pair::Pair, FastHashMap};
...
impl OutlierMetrics {
  pub fn new() -> Self {
    ...
    let dex_bad_pricing = prometheus::register_int_counter_vec!(
      "reaper_eth_engine_bad_dex_pricing",
    ...
    let branch_filtering_trigger = prometheus::register_int_counter_vec!(
      "reaper_eth_engine_branch_filtering_trigger",
