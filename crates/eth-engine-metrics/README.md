...
- [Reaper - Ethereum Engine Metrics Crate](#reaper---ethereum-engine-metrics-crate)
...
# Reaper - Ethereum Engine Metrics Crate
...
```toml
[dependencies]
reaper-eth-engine-metrics = "0.0.1"
```

Or, via the command line:

```bash
cargo add reaper-eth-engine-metrics
```
...
Run `nx build reaper-eth-engine-metrics` to build the library.

### Running unit tests

Run `nx test reaper-eth-engine-metrics` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint reaper-eth-engine-metrics` to run [ESLint](https://eslint.org/) on
the package.
